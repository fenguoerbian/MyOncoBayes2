...
blrm_mix_lupmf_comp(const int& g,
    ...
    try {
        ...
        Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> mix_ll(num_mix_comp);
        stan::math::initialize(mix_ll, DUMMY_VAR__);
        ...
        return stan::math::promote_scalar<fun_return_scalar_t__>(mix_ll);
        }
    } catch (const std::exception& e) {
        stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
        // Next line prevents compiler griping about no return
                ...
                if (as_bool(logical_eq(num_mix_comp, 1))) {
                    ...
                    for (int g = 1; g <= num_groups; ++g) {
                        ...
                        if (as_bool(logical_neq(get_base1(num_cases_group, g, "num_cases_group", 1), 0))) {
                            ...
                            stan::math::initialize(mix_ll, DUMMY_VAR__);
                            stan::math::fill(mix_ll, DUMMY_VAR__);
                            stan::math::assign(mix_ll,add(blrm_mix_lupmf_comp(g, num_groups, obs_gidx, r, n, X_comp, finite_cov, X_inter, beta, mix_idx_beta, eta, mix_idx_eta, pstream__), get_base1(mix_log_weight, g, "mix_log_weight", 1)));
    ...
    void write_array(RNG& base_rng__,
        ...
        try {
            ...
            for (int g = 1; g <= num_groups; ++g) {
                ...
                stan::math::assign(log_norm,log_sum_exp(mix_ll));
                ...
                stan::math::assign(log_EX_prob_mix,subtract(mix_ll, log_norm));
